  ...
  return (
    <div>
      ...
      <ul className="flex space-x-4">
        <li>
          <Link to={{ pathname: "https://facebook.com" }} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-500">
        ...
        <li>
          <Link to={{ pathname: "https://twitter.com" }} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-400">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <li>
          <Link to={{ pathname: "https://linkedin.com" }} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-700">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
